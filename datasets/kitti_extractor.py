...
class KITTIExtractorDataset(Dataset):
    """
    ...
    def __getitem__(self, idx):
        ...
        return key, src_pcd_input, tgt_pcd_input, src_feats, tgt_feats, rot, trans, matching_inds, src_pcd, tgt_pcd, torch.ones(1)
    ...
    def _get_velodyne_fn(self, drive, t):
        if self.IS_ODOMETRY:
            fname = self.root + '/sequences/%s/velodyne/%s.bin' % (drive, t)
        return fname
